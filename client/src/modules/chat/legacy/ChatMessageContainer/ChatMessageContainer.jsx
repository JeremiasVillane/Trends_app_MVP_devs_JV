...
export const ChatMessageContainer = ({ isGroup, socket }) => {
  ...
  useEffect(() => {
    ...
    return () => {
      socket?.off("mensaje-recibido", receivedMessage);
    };
  }, [socket]);
  ...
  return (
    <div
      ref={messagesRef}
      className="custom-scrollbar flex flex-col w-full h-full gap-2 my-1 overflow-x-hidden p-2"
    >
